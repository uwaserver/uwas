    ...
    <div className="flex min-h-screen items-center justify-center bg-[#0f172a] px-4">
      <div className="w-full max-w-sm">
        ...
        >
          ...
          {step === 'key' ? (
            <>
              <label htmlFor="apiKey" className="mb-1.5 block text-sm font-medium text-slate-300">
                API Key
              </label>
              <div className="relative">
                <KeyRound size={16} className="absolute top-1/2 left-3 -translate-y-1/2 text-slate-500" />
                <input
                  id="apiKey"
                  type="password"
                  value={key}
            ...
            <>
              <label htmlFor="totpCode" className="mb-1.5 block text-sm font-medium text-slate-300">
                Authenticator Code
              </label>
              <div className="relative">
                <ShieldCheck size={16} className="absolute top-1/2 left-3 -translate-y-1/2 text-slate-500" />
                <input
                  id="totpCode"
                  type="text"
                  inputMode="numeric"
                  ...
                  placeholder="000000"
                  autoFocus
                  className="w-full rounded-md border border-[#334155] bg-[#0f172a] py-2.5 pr-3 pl-10 text-center text-lg font-mono tracking-widest text-slate-200 placeholder-slate-500 outline-none transition focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                />
              </div>
