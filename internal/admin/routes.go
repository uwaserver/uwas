...
func (s *Server) registerDomainRoutes() {
	...
	s.mux.HandleFunc("POST /api/v1/unknown-domains/{host}/redirect", s.handleUnknownDomainsAlias)
...
func (s *Server) registerAppRoutes() {
	...
	s.mux.HandleFunc("POST /api/v1/apps/{name}/deploy-key", s.handleAppGenerateDeployKey)
	...
	s.mux.HandleFunc("GET /api/v1/software/templates", s.handleSoftwareTemplateList)
	s.mux.HandleFunc("GET /api/v1/software/instances", s.handleSoftwareInstanceList)
	s.mux.HandleFunc("GET /api/v1/software/monitor", s.handleSoftwareMonitorSummary)
	s.mux.HandleFunc("GET /api/v1/software/ports/check", s.handleSoftwarePortCheck)
	s.mux.HandleFunc("POST /api/v1/software/backups", s.handleSoftwareBackupAll)
	s.mux.HandleFunc("POST /api/v1/software/updates", s.handleSoftwareUpdateAll)
	s.mux.HandleFunc("POST /api/v1/software/install", s.handleSoftwareInstall)
	s.mux.HandleFunc("DELETE /api/v1/software/{name}", s.handleSoftwareDelete)
	s.mux.HandleFunc("POST /api/v1/software/{name}/start", s.handleSoftwareStart)
	s.mux.HandleFunc("POST /api/v1/software/{name}/stop", s.handleSoftwareStop)
	s.mux.HandleFunc("POST /api/v1/software/{name}/restart", s.handleSoftwareRestart)
	s.mux.HandleFunc("POST /api/v1/software/{name}/update", s.handleSoftwareUpdate)
	s.mux.HandleFunc("POST /api/v1/software/{name}/domain", s.handleSoftwareDomainConnect)
	s.mux.HandleFunc("DELETE /api/v1/software/{name}/domain", s.handleSoftwareDomainDisconnect)
	...
	s.mux.HandleFunc("POST /api/v1/software/{name}/restore", s.handleSoftwareRestore)
...
func (s *Server) registerSystemAdminRoutes() {
	...
	s.mux.HandleFunc("POST /api/v1/firewall/{number}/move", s.handleFirewallMove)
	...
	s.mux.HandleFunc("POST /api/v1/firewall/confirm", s.handleFirewallConfirm)
