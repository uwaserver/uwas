...
func TestSplitScriptPath(t *testing.T) {
	tests := []struct {
		...
		{"wp-admin direct", "/wp-admin/admin.php", "/var/www/wp-admin/admin.php", "/wp-admin/admin.php", ""},
		{"wp-admin dir index", "/wp-admin/", "/var/www/wp-admin/index.php", "/wp-admin/index.php", ""},
		{"wp-includes dir", "/wp-includes/js/", "/var/www/wp-includes/js/index.php", "/wp-includes/js/index.php", ""},
